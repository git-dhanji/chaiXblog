...
export default function WebPolicy() {
    return (
        <section>
            <div className="max-w-4xl mx-auto px-4 py-8 dark:bg-slate-900 dark:text-red-50">
                <h1 className="text-3xl font-bold mb-4">Privacy Policy</h1>
                <div className="text-lg leading-relaxed">
                    <p>
                        This Privacy Policy describes how your personal information is collected, used, and shared when you visit our blog website (the chaixblog).
                    </p>
